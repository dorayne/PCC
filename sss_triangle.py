...
print "\nThe lengths of the sides of the triangle are {}, {}, and {}".format(SIDE_A, SIDE_B, SIDE_C)
print "The area of the triangle is {} square units" .format(AREA)
print "The angles of the triangle in degrees are {}, {}, and {}" .format(DEG_1, DEG_2, DEG_3)
